...
import Questions from '../Protected/Questions'
      ...
      <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
        <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
          <div class="space-y-6 md:7/12 lg:w-6/12">
            <h2 class="text-2xl text-blue-900 font-bold md:text-5xl">Practice makes perfect</h2>
            <div class="space-y-4">
              <p class="text-gray-600">Select a category for a random interview question.</p>
              <p class="mt-4 text-gray-600"> Practice and record your response, then share your videos for rating and comments from fellow users.</p>
              <p class="mt-4 text-gray-600"> Review other videos. Give constructive feedback and build great community</p>
          ...
          <div class="md:5/12 lg:w-6/12 rounded-lg">
          ...
          <div className="mt-2 text-slate-500">{recordedChunks.length > 0 && (
            <div className="d-flex">
              ...
              <button className="flex bg-transparent border border-yellow-500 text-sm md:text-lg text-yellow-500 hover:bg-yellow-500 hover:text-white text-center p-2 my-4 rounded"
                ...
                <svg width="24" height="24" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-2">
