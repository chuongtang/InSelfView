    ...
    <div >
      ...
      <div className="flex mt-9">
        ...
        <div className="flex-col ml-8">
          ...
          {capturing ? (
            <button
              className="flex bg-red-700 hover:bg-red-300 text-white text-center p-2 rounded"
            ...
            <button
              className="flex bg-gray-400 hover:bg-gray-900 text-white text-center p-2 rounded"
          ...
          {recordedChunks.length > 0 && (
            <div className="flex mt-8 ">
              <button
                className="flex bg-transparent border border-green-500 text-green-500 hover:bg-green-500 hover:text-white text-center p-2 rounded mr-4"
              ...
              <button
                className="flex bg-transparent border border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-white text-center p-2 rounded"
