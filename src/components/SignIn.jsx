                ...
                <div className="mt-4 text-xl">
                  <form onSubmit={submitHandler}>
                    ...
                    <div className="flex flex-wrap -mx-3 mt-6">
                      <div className="w-full px-3">
                        <button className="btn text-white bg-gray-600 hover:bg-green-500 w-full relative flex items-center p-4 justify-center rounded-lg" type="submit">
                          Sign in
                  ...
                  <form>
                    <div className="flex flex-wrap -mx-3 mb-3">
                      <div className="w-full px-3">
                        <button className="btn px-0 text-white bg-gray-900 hover:bg-gray-800 w-full relative flex items-center py-4 rounded-lg" type="button" onClick={() => logInGH()}>
