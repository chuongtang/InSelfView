        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          ...
          {/* <button className="inline-flex items-center p-2 pl-5 pr-5 bg-blue-500 text-gray-100 text-lg rounded-lg focus:border-4 border-blue-300">Learn More...
            <svg width="24" height="24" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.5 7.5L12 11L15.5 7.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M8.5 13.5L12 17L15.5 13.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
