                ...
                <form>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input id="name" type="text" className="form-input w-full text-gray-800 py-4 rounded-lg" placeholder="Enter your name" required />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input id="password" type="password" className="form-input w-full text-gray-800 py-4 rounded-lg" placeholder="Enter your password" required />
                    </div>
                  </div>
